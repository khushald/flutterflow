...
class _PostCopyWidgetState extends State<PostCopyWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'postCopy'});
    if (!isWeb) {
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  wrapWithModel(
                                    ...
                                    child: ReplyWidget(
                                      parameter5: widget.comment?.reference,
                                      post: widget.comment!.parentReference,
                                    ),
                                  ),
                                ],
                              ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'POST_COPY_PAGE_send_sharp_ICN_ON_TAP');
                                  if (_model.textController.text != null &&
                                      _model.textController.text != '') {
                                    logFirebaseEvent('IconButton_backend_call');

                                    await CommentrepliesRecord.createDoc(
                                            widget.comment!.parentReference)
