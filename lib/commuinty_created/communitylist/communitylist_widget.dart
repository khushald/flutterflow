...
class _CommunitylistWidgetState extends State<CommunitylistWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'communitylist'});
              ...
              actions: [
                Padding(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('COMMUNITYLIST_PAGE_add_ICN_ON_TAP');
                                  ...
                                  child: StreamBuilder<List<CommunitiesRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount: listViewCommunitiesRecordList
                                            .length,
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'COMMUNITYLIST_PAGE_Row_guhv1lfe_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_navigate_to');
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'COMMUNITYLIST_PAGE_Text_wyx3pbc6_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Text_navigate_to');
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'COMMUNITYLIST_PAGE_Row_i7m1gb3o_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_navigate_to');
