            ...
            Container(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('DELETEPOST_COMP_Row_nffgwvb6_ON_TAP');
                    if (widget.post?.postUser == currentUserReference) {
                      ...
                      var confirmDialogResponse = await showDialog<bool>(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: Text('do yo want to delete it ?'),
                                actions: [
                                  TextButton(
                      ...
                      var confirmDialogResponse = await showDialog<bool>(
                          ...
                          false;
                      if (confirmDialogResponse) {
                        if ((currentUserDocument?.communityownedlist
                                    ?.toList() ??
                                [])
                            .contains(widget.post?.postCommunity)) {
                          logFirebaseEvent('Row_backend_call');
                          await widget.post!.reference.delete();
                        } else if ((currentUserDocument?.moderator?.toList() ??
                                [])
                            .contains(widget.post?.postCommunity)) {
                          logFirebaseEvent('Row_backend_call');
                          await widget.post!.reference.delete();
